class MyroomCheckModel {
  MyroomCheckModelData data;
  Null message;
  int status;

  MyroomCheckModel({this.data, this.message, this.status});

  MyroomCheckModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null
        ? new MyroomCheckModelData.fromJson(json['data'])
        : null;
...
class MyroomCheckModelData {
  ...
  MyroomCheckModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
